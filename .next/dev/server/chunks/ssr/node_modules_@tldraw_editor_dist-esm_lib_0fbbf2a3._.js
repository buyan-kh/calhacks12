...
("TURBOPACK compile-time truthy", 1) ? "node" : "TURBOPACK unreachable");
...
"[project]/node_modules/@tldraw/editor/dist-esm/lib/utils/EditorAtom.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class EditorAtom {
    ...
    states = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$cache$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WeakCache"]();
    getAtom(editor) {
        return this.states.get(editor, ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$state$2f$dist$2d$esm$2f$lib$2f$Atom$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["atom"])(this.name, this.getInitialState(editor)));
    }
    get(editor) {
...
function getOverlappingShapes(editor, shape, otherShapes) {
    ...
    if (!_shape) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$state$2f$dist$2d$esm$2f$lib$2f$helpers$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EMPTY_ARRAY"];
...
const userTypeValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$lib$2f$validation$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__T$3e$__["T"].object({
    ...
    enhancedA11yMode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$lib$2f$validation$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__T$3e$__["T"].boolean.nullable().optional(),
    inputMode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$lib$2f$validation$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__T$3e$__["T"].literalEnum("trackpad", "mouse").nullable().optional()
});
const Versions = {
    AddAnimationSpeed: 1,
    AddIsSnapMode: 2,
...
function getExportDefaultBounds(editor, renderingShapes, padding, singleFrameShapeId) {
    ...
    for (const { id } of renderingShapes){
        ...
        if (bbox) {
            if (isContainer && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Box$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Box"].ContainsApproximately(maskedPageBounds, bbox)) {
                isBoundedByContainer = true;
                bbox = maskedPageBounds.clone();
            } else {
                if (isBoundedByContainer && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Box$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Box"].ContainsApproximately(bbox, maskedPageBounds)) {
...
function SvgExport({ editor, preserveAspectRatio, scale, pixelRatio, bbox, background, singleFrameShapeId, isDarkMode, renderingShapes, onMount, waitUntil }) {
    ...
    if (singleFrameShapeId && background) {
        ...
        if (frameShapeUtil?.options.showColors) {
            ...
            backgroundColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$styles$2f$TLColorStyle$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getColorValue"])(theme, shape.props.color, "frameFill");
        } else {
...
class LicenseManager {
    ...
    maybeTrack(result, licenseState) {
        ...
        url.searchParams.set("version", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$version$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["version"]);
...
function LicenseProvider({ licenseKey = getLicenseKeyFromEnv() ?? void 0, children }) {
    ...
    const licenseState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$state$2d$react$2f$dist$2d$esm$2f$lib$2f$useValue$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useValue"])(licenseManager.state);
    const [showEditor, setShowEditor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    if (shouldHideEditorAfterDelay(licenseState) && !showEditor) {
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(LicenseGate, {});
    }
...
const UnlicensedWatermark = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"])(function UnlicensedWatermark2({ isDebugMode, isMobile }) {
    const editor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$hooks$2f$useEditor$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEditor"])();
...
const WatermarkInner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"])(function WatermarkInner2({ src, isUnlicensed }) {
    const editor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$hooks$2f$useEditor$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEditor"])();
    ...
    if (isUnlicensed) {
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(UnlicensedWatermark, {
            isDebugMode,
            isMobile
        });
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$hooks$2f$useStateAttribute$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tldraw/editor/dist-esm/lib/hooks/useStateAttribute.mjs [app-ssr] (ecmascript)");
...
function Layout({ children, onMount }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$hooks$2f$useStateAttribute$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStateAttribute"])();
    useOnMount((editor)=>{
...
//# sourceMappingURL=node_modules_%40tldraw_editor_dist-esm_lib_0fbbf2a3._.js.map