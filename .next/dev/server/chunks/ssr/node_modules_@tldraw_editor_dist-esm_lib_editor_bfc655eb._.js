...
class HandleSnaps {
    ...
    *iterateSnapOutlines(currentShapeId, currentHandle) {
    ...
    getHandleSnapData({ handle, currentShapeId }) {
        ...
        const nudge = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vec"](nearestXSnap ? nearestXSnap.x - handleInPageSpace.x : 0, nearestYSnap ? nearestYSnap.y - handleInPageSpace.y : 0);
        const snappedHandle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vec"].Add(handleInPageSpace, nudge);
        const snaps = [];
        if (nearestXSnap) {
            const snappedHandleOnX = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vec"](nearestXSnap.x, snappedHandle.y);
            snaps.push({
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$id$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uniqueId"])(),
                type: "points",
                points: [
        ...
        if (nearestYSnap) {
            const snappedHandleOnY = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vec"](snappedHandle.x, nearestYSnap.y);
            snaps.push({
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$id$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uniqueId"])(),
                type: "points",
                points: [
...
;
;
const throttleToNextFrame = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$throttle$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["throttleToNextFrame"];
_tick_dec = [
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$bind$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bind"]
], _dispose_dec = [
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$bind$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bind"]
...
class UserPreferencesManager {
    constructor(user, inferDarkMode){
        ...
        ;
        const darkModeMediaQuery = undefined;
    ...
    getEnhancedA11yMode() {
        return this.user.userPreferences.get().enhancedA11yMode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$config$2f$TLUserPreferences$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultUserPreferences"].enhancedA11yMode;
    }
    getInputMode() {
        return this.user.userPreferences.get().inputMode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$config$2f$TLUserPreferences$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultUserPreferences"].inputMode;
    }
}
_init = __decoratorStart(null);
...
class Editor extends (_a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventemitter3$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], _getIsShapeHiddenCache_dec = [
   ...
   */ getShapePageTransform(shape) {
    ...
    _getShapePageBoundsCache() {
        return this.store.createComputedCache("pageBoundsCache", (shape)=>{
            ...
            if (!pageTransform) return void 0;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Box$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Box"].FromPoints(pageTransform.applyToPoints(this.getShapeGeometry(shape).boundsVertices));
        });
    }
    /**
   ...
   */ getHighestIndexForParent(parent) {
        ...
        if (!children || children.length === 0) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$reordering$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getIndexAbove"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$reordering$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_INDEX_KEY"]);
        }
   ...
   */ duplicateShapes(shapes, offset) {
        this.run(()=>{
            ...
            this.setSelectedShapes((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$array$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compact"])(ids.map((oldId)=>{
   ...
   */ async toImageDataUrl(shapes, opts = {}) {
        ...
        return {
            url: await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$file$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FileHelpers"].blobToDataUrl(blob),
            width,
            height
        };
    }
   ...
   */ updatePointer(options) {
        const event = {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vec"].Add(this.inputs.currentScreenPoint, this.store.unsafeGetWithoutCapture(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$records$2f$TLInstance$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TLINSTANCE_ID"]).screenBounds),
            ...
            accelKey: options?.accelKey ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$keyboard$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAccelKey"])(this.inputs)
        };
...
//# sourceMappingURL=node_modules_%40tldraw_editor_dist-esm_lib_editor_bfc655eb._.js.map