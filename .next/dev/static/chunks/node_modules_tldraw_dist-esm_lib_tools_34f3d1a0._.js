...
const updateHoveredShapeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["throttle"])(_updateHoveredShapeId, ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 32);
;
...
class Erasing extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"] {
    ...
    _erasingShapeIds = [];
    onEnter(info) {
        this._isHoldingAccelKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$keyboard$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAccelKey"])(this.editor.inputs);
...
class Brushing extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"] {
    ...
    onEnter(info) {
        ...
        this.cleanupViewportChangeReactor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$state$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["react"])("viewport change while brushing", ()=>{
...
function getTranslateCroppedImageChange(editor, shape, delta) {
    ...
    const newCrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["structuredClone"])(oldCrop);
...
class DraggingHandle extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"] {
    ...
    onEnter(info) {
        ...
        this.initialHandle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["structuredClone"])(handle);
        ...
        const handles = this.editor.getShapeHandles(shape).sort(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortByIndex"]);
    ...
    update() {
        ...
        if (initialHandle.canSnap && initialHandle.snapType) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["warnOnce"])("canSnap is deprecated. Cannot use both canSnap and snapType together - snapping disabled. Please use only snapType.");
        } else {
...
function selectOnCanvasPointerUp(editor, info) {
    ...
    if (hitShape) {
        ...
        if (additiveSelectionKey) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isShapeId"])(focusedGroupId)) {
...
class Idle extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"] {
    ...
    isOverArrowLabelTest(shape) {
        if (!shape) return false;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$arrow$2f$arrowLabel$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isOverArrowLabel"])(this.editor, shape);
    }
        ...
        this.editor.createShapes([
            {
                ...
                y,
                props: {
                    richText: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toRichText"])(""),
                    autoSize: true
                }
            }
        ]);
...
class PointingShape extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"] {
    ...
    onPointerMove(info) {
        if (this.editor.inputs.isDragging) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$arrow$2f$arrowLabel$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isOverArrowLabel"])(this.editor, this.hitShape)) {
    ...
    _createSnapshot() {
        ...
        const populateResizingShapes = (shapeId)=>{
            ...
            if (editor.isShapeOfType(shape, "frame")) {
                frames.push({
                    id: shape.id,
                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(editor.getSortedChildIdsForParent(shape).map((id)=>editor.getShape(id)))
                });
            }
...
class DragAndDropManager {
    ...
    startDraggingShapes(movingShapes, point, cb) {
        ...
        for (const movingGroup of movingGroups){
            const children = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(editor.getSortedChildIdsForParent(movingGroup).map((id)=>editor.getShape(id)));
    ...
    updateDraggingShapes(point, cb) {
        const { editor } = this;
        const draggingShapes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(this.shapesToActuallyMove.map((s)=>editor.getShape(s)));
        ...
        editor.run(()=>{
            if (this.prevDraggingOverShape?.id === nextDraggingOverShape?.id) {
                if (cursorDidMove && nextDraggingOverShape && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isShapeId"])(nextDraggingOverShape.id) && !editor.inputs.previousPagePoint.equals(editor.inputs.currentPagePoint)) {
...
class Translating extends (_a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"], _updateParentTransforms_dec = [
    ...
    handleStart() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(this.snapshot.movingShapes.map((s)=>this.editor.getShape(s.id))), // Start from the place where the user started dragging
...
function getTranslatingSnapshot(editor) {
    ...
    const pagePoints = [];
    const selectedShapeIds = editor.getSelectedShapeIds();
    const shapeSnapshots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(selectedShapeIds.map((id)=>{
...
function moveShapesToPoint({ editor, snapshot }) {
    ...
    editor.updateShapes((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(shapeSnapshots.map(({ shape, pagePoint, parentTransform })=>{
...
class SelectTool extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$editor$2f$tools$2f$StateNode$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateNode"] {
    ...
    onEnter() {
        this.reactor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$state$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["react"])("clean duplicate props", ()=>{
            try {
...
//# sourceMappingURL=node_modules_tldraw_dist-esm_lib_tools_34f3d1a0._.js.map