...
"[project]/node_modules/tldraw/dist-esm/lib/utils/frames/frames.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function removeFrame(editor, ids) {
    const frames = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(ids.map((id)=>editor.getShape(id)).filter((f)=>f && editor.isShapeOfType(f, "frame")));
    ...
    editor.run(()=>{
        frames.map((frame)=>{
            ...
            if (children.length) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$reparenting$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["kickoutOccludedShapes"])(editor, children, {
...
function getFrameChildrenBounds(children, editor, opts = {
    ...
    const bounds = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Box$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box"].FromPoints(children.flatMap((shape)=>{
        if (!shape) return [];
...
function fitFrameToContent(editor, id, opts = {}) {
    ...
    const children = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(childIds.map((id2)=>editor.getShape(id2)));
    if (!children.length) return;
    const { w, h, dx, dy } = getFrameChildrenBounds(children, editor, opts);
    if (dx === 0 && dy === 0 && frame.props.w === w && frame.props.h === h) return;
    const diff = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"](dx, dy).rot(frame.rotation);
    editor.run(()=>{
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/clipboard.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAdditionalClipboardWriteType(format) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnProperty"])(additionalClipboardWriteTypes, format) ?? null;
}
function getCanonicalClipboardReadType(mimeType) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnProperty"])(canonicalClipboardReadTypes, mimeType) ?? mimeType;
}
...
function clipboardWrite(types) {
    ...
    return navigator.clipboard.write([
        ...
        return Promise.all(entries.map(async ([type, promise])=>{
            ...
            const resolvedTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["objectMapFromEntries"])(entries2);
            return navigator.clipboard.write([
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/export/export.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function exportToString(editor, ids, format, opts = {}) {
    switch(format){
        ...
        default:
            {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exhaustiveSwitchError"])(format);
            }
    }
}
...
function exportToImagePromiseForClipboard(editor, ids, opts = {}) {
    ...
    return {
        blobPromise: editor.toImage(idsToUse, opts).then((result)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileHelpers"].rewriteMimeType(result.blob, clipboardMimeTypesByFormat[format])),
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/export/copyAs.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$export$2f$export$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/tldraw/dist-esm/lib/utils/export/export.mjs [app-client] (ecmascript)");
;
;
;
function copyAs(editor, ids, opts) {
    ...
    if (navigator.clipboard.write) {
        const { blobPromise, mimeType } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$export$2f$export$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportToImagePromiseForClipboard"])(editor, ids, opts);
        const types = {
            [mimeType]: blobPromise
        };
        const additionalMimeType = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$clipboard$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdditionalClipboardWriteType"])(opts.format);
        if (additionalMimeType && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$clipboard$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doesClipboardSupportType"])(additionalMimeType)) {
            types[additionalMimeType] = blobPromise.then((blob)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileHelpers"].rewriteMimeType(blob, additionalMimeType));
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$clipboard$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clipboardWrite"])(types);
    }
    switch(opts.format){
        case "svg":
            {
        ...
        default:
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exhaustiveSwitchError"])(opts.format);
    }
}
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/export/exportAs.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    if (!name) {
        ...
        if (ids.length === 1) {
            ...
            if (editor.isShapeOfType(first, "frame")) {
                ...
                name = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$hooks$2f$useSafeId$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeId"])(first.id)} at ${getTimestamp()}`;
            }
        }
    }
    name += `.${opts.format}`;
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/assets/assets.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function downsizeImage(blob, width, height, opts = {}) {
    ...
    const [desiredWidth, desiredHeight] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$browserCanvasMaxSize$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clampToBrowserMaxCanvasSize"])(Math.min(width * 2, w), Math.min(height * 2, h));
    const canvas = document.createElement("canvas");
    canvas.width = desiredWidth;
    canvas.height = desiredHeight;
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertExists"])(canvas.getContext("2d", {
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/excalidraw/putExcalidrawContent.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function putExcalidrawContent(editor, excalidrawClipboardContent, point) {
    ...
    elements.forEach((element)=>{
        excElementIdsToTldrawShapeIds.set(element.id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createShapeId"])());
    ...
    let index = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZERO_INDEX_KEY"];
    for (const element of elements){
            ...
            case "diamond":
                {
                    ...
                    tldrawContent.shapes.push({
                        ...
                        props: {
                            ...
                            richText: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toRichText"])(text),
                            align,
            ...
            case "line":
                {
                    ...
                    const indices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getIndices"])(element.points.length);
                    tldrawContent.shapes.push({
                        ...base,
                        type: "line",
                        props: {
            ...
            case "arrow":
                {
                    ...
                    if (startTargetId) {
                        tldrawContent.bindings.push({
                            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBindingId"])(),
                            typeName: "binding",
                            type: "arrow",
                            fromId: id,
                            toId: startTargetId,
            ...
            case "text":
                {
                    ...
                    tldrawContent.shapes.push({
                        ...
                        props: {
                            ...
                            color: colorsToColors[element.strokeColor] ?? "black",
                            richText: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toRichText"])(element.text),
            ...
            case "image":
                {
                    ...
                    if (!file) break;
                    const assetId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssetRecordType"].createId();
        ...
        index = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getIndexAbove"])(index);
    }
    ...
    for (const groupedShapeIds of groupShapeIdToChildren.values()){
        if (groupedShapeIds.length > 1) {
            ...
            if (groupShape?.parentId && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isShapeId"])(groupShape.parentId)) {
    ...
    const rootShapes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compact"])(rootShapeIds.map((id)=>editor.getShape(id)));
    const bounds = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Box$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box"].Common(rootShapes.map((s)=>editor.getShapePageBounds(s)));
...
function getBend(element, startPoint, endPoint) {
    ...
    if (element.points.length > 2) {
        const start = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"](startPoint[0], startPoint[1]);
        const end = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"](endPoint[0], endPoint[1]);
        const handle = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"](element.points[1][0], element.points[1][1]);
        const delta = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Sub(end, start);
        const v = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Per(delta);
        const med = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Med(end, start);
        const A = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Sub(med, v);
        const B = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Add(med, v);
        const point = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].NearestPointOnLineSegment(A, B, handle, false);
        bend = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Dist(point, med);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Clockwise(point, end, med)) bend *= -1;
    }
    return bend;
}
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/text/textDirection.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const TextDirection = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
    name: "textDirection",
    addGlobalAttributes () {
        return [
            {
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/text/richText.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$text$2f$textDirection$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/tldraw/dist-esm/lib/utils/text/textDirection.mjs [app-client] (ecmascript)");
;
;
;
;
...
;
;
const KeyboardShiftEnterTweakExtension = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$extension$2d$code$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].config.excludes = void 0;
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$extension$2d$highlight$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].config.priority = 1100;
const tipTapDefaultExtensions = [
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$extension$2d$highlight$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
    KeyboardShiftEnterTweakExtension,
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$text$2f$textDirection$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextDirection"]
];
const htmlCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WeakCache"]();
function renderHtmlFromRichText(editor, richText) {
    return htmlCache.get(richText, ()=>{
        ...
        const html = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateHTML"])(richText, tipTapExtensions);
...
const plainTextFromRichTextCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WeakCache"]();
...
function renderPlaintextFromRichText(editor, richText) {
    ...
    return plainTextFromRichTextCache.get(richText, ()=>{
        const tipTapExtensions = editor.getTextOptions().tipTapConfig?.extensions ?? tipTapDefaultExtensions;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateText"])(richText, tipTapExtensions, {
            blockSeparator: "\n"
        });
    });
}
function renderRichTextFromHTML(editor, html) {
    const tipTapExtensions = editor.getTextOptions().tipTapConfig?.extensions ?? tipTapDefaultExtensions;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateJSON"])(html, tipTapExtensions);
}
function defaultAddFontsFromNode(node, state, addFont) {
    ...
    const fontsForFamily = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnProperty"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$shared$2f$defaultFonts$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DefaultFontFaces"], state.family);
    if (!fontsForFamily) return state;
    const fontsForStyle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnProperty"])(fontsForFamily, state.style);
    if (!fontsForStyle) return state;
    const fontsForWeight = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnProperty"])(fontsForStyle, state.weight);
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/text/text.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$shared$2f$TextHelpers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/tldraw/dist-esm/lib/shapes/shared/TextHelpers.mjs [app-client] (ecmascript)");
;
...
function replaceTabsWithSpaces(text) {
    return text.replace(/\t/g, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$shared$2f$TextHelpers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDENT"]);
}
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/embeds/embeds.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function matchEmbedUrl(definitions, url) {
    const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeParseUrl"])(url);
    if (!parsed) return;
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/shapes/shapes.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/static-assets/assetUrls.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let defaultEditorAssetUrls = {
    fonts: {
        tldraw_mono: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexMono-Medium.woff2`,
        tldraw_mono_italic: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexMono-MediumItalic.woff2`,
        tldraw_mono_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexMono-Bold.woff2`,
        tldraw_mono_italic_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexMono-BoldItalic.woff2`,
        tldraw_serif: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSerif-Medium.woff2`,
        tldraw_serif_italic: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSerif-MediumItalic.woff2`,
        tldraw_serif_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSerif-Bold.woff2`,
        tldraw_serif_italic_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSerif-BoldItalic.woff2`,
        tldraw_sans: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSans-Medium.woff2`,
        tldraw_sans_italic: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSans-MediumItalic.woff2`,
        tldraw_sans_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSans-Bold.woff2`,
        tldraw_sans_italic_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/IBMPlexSans-BoldItalic.woff2`,
        tldraw_draw: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/Shantell_Sans-Informal_Regular.woff2`,
        tldraw_draw_italic: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/Shantell_Sans-Informal_Regular_Italic.woff2`,
        tldraw_draw_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/Shantell_Sans-Informal_Bold.woff2`,
        tldraw_draw_italic_bold: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$utils$2f$assets$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCdnBaseUrl"])()}/fonts/Shantell_Sans-Informal_Bold_Italic.woff2`
    }
};
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/assets/preload-font.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/tldr/buildFromV1Document.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    editor.run(()=>{
        ...
        Object.values(document.pages ?? {}).sort((a, b)=>(a.childIndex ?? 1) < (b.childIndex ?? 1) ? -1 : 1).forEach((v1Page, i)=>{
            if (i === 0) {
                ...
                const pageId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageRecordType"].createId();
                            ...
                            editor.createShapes([
                                {
                                    ...
                                    type: "note",
                                    props: {
                                        richText: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toRichText"])(v1Shape.text ?? ""),
                            ...
                            editor.createShapes([
                                {
                                    ...
                                    props: {
                                        ...
                                        richText: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$tlschema$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toRichText"])(v1Shape.label ?? ""),
                    ...
                    case "arrow" /* Arrow */ :
                        {
                            ...
                            const dist = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$Vec$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec"].Dist(v1Start, v1End);
                ...
                for (const handleId of [
                    ...
                    if (bindingId) {
                        ...
                        if (targetId) {
                            ...
                            const nx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$utils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clamp"])((coerceNumber(binding.point[0]) + 0.5) / 2, 0.2, 0.8);
                            const ny = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$lib$2f$primitives$2f$utils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clamp"])((coerceNumber(binding.point[1]) + 0.5) / 2, 0.2, 0.8);
                            ...
                            const freshBinding = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$arrow$2f$shared$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getArrowBindings"])(editor, editor.getShape(v2ShapeId))[handleId];
                            if (freshBinding) {
                                const updatedFreshBinding = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["structuredClone"])(freshBinding);
...
async function tryMigrateAsset(editor, placeholderAsset) {
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetch"])(placeholderAsset.props.src);
...
"[project]/node_modules/tldraw/dist-esm/lib/utils/tldr/file.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$editor$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@tldraw/editor/dist-esm/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tldraw/utils/dist-esm/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$store$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tldraw/store/dist-esm/index.mjs [app-client] (ecmascript)");
...
const schemaV1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].object({
    schemaVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].literal(1),
    storeVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].positiveInteger,
    recordVersions: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].dict(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].string, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].object({
        version: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].positiveInteger,
        ...
        subTypeKey: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].string.optional()
    }))
});
const schemaV2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].object({
    schemaVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].literal(2),
...
const tldrawFileValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].object({
    tldrawFileFormatVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].nonZeroInteger,
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].numberUnion("schemaVersion", {
        1: schemaV1,
        2: schemaV2
    }),
    records: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].arrayOf(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].object({
        id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].string,
        typeName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$validate$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"].string
...
function parseTldrawJsonFile({ json, schema }) {
    ...
    try {
        ...
        try {
            ...
            if (isV1File(data)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Result"].err({
                    type: "v1File",
                    data
                });
            }
...
async function parseAndLoadDocument(editor, document, msg, addToast, onV1FileLoad, forceDarkMode) {
    ...
    if (!parseFileResult.ok) {
        ...
        switch(parseFileResult.error.type){
            ...
            case "migrationFailed":
                if (parseFileResult.error.reason === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$store$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MigrationFailureReason"].TargetVersionTooNew) {
                    description = msg("file-system.file-open-error.file-format-version-too-new");
                } else {
            ...
            case "v1File":
                {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$utils$2f$tldr$2f$buildFromV1Document$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildFromV1Document"])(editor, parseFileResult.error.data.document);
                    onV1FileLoad?.();
                    return;
                }
            default:
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exhaustiveSwitchError"])(parseFileResult.error, "type");
        }
        addToast({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$state$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transact"])(()=>{
...
async function extractAssets(editor, snapshot, msg, addToast) {
    ...
    Promise.allSettled([
        ...
        try {
            const blob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetch"])(asset.props.src).then((r)=>r.blob());
            const file = new File([
                blob
            ], asset.props.name, {
...
//# sourceMappingURL=node_modules_tldraw_dist-esm_lib_utils_b44d6b1e._.js.map